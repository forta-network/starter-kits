...
TORNADO_CASH_TRANSFER_COUNT_THRESHOLD_ETH = 3  # how many tornado cash transfers should be in a block range to be considered suspicious; currently configured to be about 1M USD
TORNADO_CASH_TRANSFER_COUNT_THRESHOLD_MATIC = 100  # how many tornado cash transfers should be in a block range to be considered suspicious; currently configured to be about 1M USD
...
TORNADO_CASH_ADDRESSES = {1: "0xA160cdAB225685dA1d56aa342Ad8841c3b53f291",  # Ethereum Mainnet - 100 ETH
                          56: "0x1E34A77868E19A6647b1f2F47B51ed72dEDE95DD",  # BSC - 100 ETH
