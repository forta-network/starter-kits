...
class TestChangeNowFundingAgent:
    ...
    async def test_agent_latency(self, mocker):
        ...
        processing_runs = 10
        processing_time_no_funding = await async_timeit(agent.detect_changenow_funding, real_w3, transaction_with_no_funding) / processing_runs
        processing_time_changenow_to_contract = await async_timeit(agent.detect_changenow_funding, real_w3, transaction_from_changenow_to_contract) / processing_runs
        processing_time_with_changenow_funding = await async_timeit(agent.detect_changenow_funding, real_w3, transaction_with_changenow_funding) / processing_runs
