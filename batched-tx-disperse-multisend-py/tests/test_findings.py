...
def test_format():
    _f = findings.FormatBatchTxFinding(txhash='', sender=SENDER, receiver=RECEIVER, token='ERC20', transfers=[], chain_id=1, confidence_score=0.5, malicious_score=0.5)
...
def test_alert_ids():
    _f_erc20 = findings.FormatBatchTxFinding(txhash='', sender=SENDER, receiver=RECEIVER, token='ERC20', transfers=[], chain_id=1, confidence_score=0.5, malicious_score=0.5)
    _f_native = findings.FormatBatchTxFinding(txhash='', sender=SENDER, receiver=RECEIVER, token='ETH', transfers=[], chain_id=1, confidence_score=0.5, malicious_score=0.5)
...
def test_severity_increases_when_malicious_score_increases():
    _f_erc20 = findings.FormatBatchTxFinding(txhash='', sender=SENDER, receiver=RECEIVER, token='ERC20', transfers=[], chain_id=1, confidence_score=0.9, malicious_score=0.7)
