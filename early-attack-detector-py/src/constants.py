...
MODEL_PATH = 'deployed_models/2024080217_eec.joblib'
HIGH_PRECISION_MODEL_PATH = 'deployed_models/2024080217_brcf.joblib'
MODEL_THRESHOLD_ETH = .5
MODEL_THRESHOLD_ETH_PRECISION = 1.1
MODEL_THRESHOLD_DEFAULT = .5
MODEL_THRESHOLD_DEFAULT_PRECISION = 1.1

MODEL_INFO_THRESHOLD = .5
