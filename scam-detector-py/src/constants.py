...
MODEL_ALERT_THRESHOLD_LOOSE = 0.47  # precison of 6/8 (75%) on test set; 39/40 (97%) on train set
MODEL_ALERT_THRESHOLD_STRICT = 0.65  # precision of 100% on test and train set
