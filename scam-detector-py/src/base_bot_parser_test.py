...
class TestBaseBotParser:
    ...
    def test_get_fromAddr_nft_order_metadata(self):
        ...
        alert_event = TestBaseBotParser.generate_alert("0x15e9b3cd277d3be1fcfd5e23d61b3496026d8c3d9c98ef47a48e37b3c216ab9f", "nft-phishing-sale", "description", metadata)
        addresses = BaseBotParser.get_scammer_addresses(w3,alert_event)
