...
class AlertCombinerFinding:
    ...
    def alert_combiner(attacker_address: str, start_date: datetime, end_date: datetime, involved_addresses: set, involved_alerts: set, alert_id: str, hashes: set) -> Finding:
        ...
        labels = []
        if alert_id == "ATTACK-DETECTOR-ICE-PHISHING" or alert_id == 'ATTACK-DETECTOR-FRAUDULENT-SEAPORT-ORDER' or alert_id == 'ATTACK-DETECTOR-1' or alert_id == 'ATTACK-DETECTOR-ADDRESS-POISONING':
            labels = [Label({
